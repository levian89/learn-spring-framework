...
public class HelloWorldConfiguration {
    ...
    @Bean                               // auto-wiring of a method parameter (address2 because it is @Primary)
    ...
    @Bean
    public Person person5Qualifier(String name, int age, @Qualifier("address3qualifier") Address address2) {  //name, age, address2
        return new Person(name, age, address2); //name, age, address
    }
